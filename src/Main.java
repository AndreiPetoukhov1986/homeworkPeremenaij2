public class Main {
    public static void main(String[] args) {
        ...
        int wite = 2;
        int brown = 4;
        int oneClass = wite+brown;
        int t = totalPaint/oneClass;
        int witePaint = t*2;
        int brownPaint = t*4;
        System.out.println("В школе, где " + t + " классов, нужно " + witePaint +  " банок белой краски и " + brownPaint + " банок коричневой краски");
